...
include <MCAD/transformations.scad>
...
//    rect_tube(size=[raised_bed_length, raised_bed_width], wall=2, h=12);
//    
//  // center bed
//  rect_tube(size=[raised_bed_width, raised_bed_width], wall=2, h=12);
//  
//  // left and right
//  xcopies(spacing=16*12, n=2)
//    rect_tube(size=[raised_bed_width, raised_bed_length], wall=2, h=12);
//}
//
//module signs() {
//  translate([ 60, -60, 10])
...
translate([0,arbor_height-arbor_width,0])
  difference() {
    cylinder(h=arbor_depth, r=(arbor_width+arbor_thickness)/2);
    translate([0,0,-1])
      cylinder(h=arbor_depth+2, r=(arbor_width-arbor_thickness)/2);
    translate([-arbor_width-2,-arbor_width*2,-1])
      cube([arbor_width+1,arbor_width,arbor_depth+2]);
  }